        ...
        <div>
            <div className="w-full min-h-screen relative">
                ...
                <div className="w-[194px] h-16 absolute bottom-24 right-48">
                    ...
                    <button className="w-[140px] h-14 left-7 top-1 absolute text-center text-zinc-100 text-lg font-medium font-['Inter'] select-none"
                ...
                <div className="w-[1261.03px]  relative flex-col justify-start items-start inline-flex">
                    <div className="absolute top-3 left-14  w-[138.16px] h-[157px] bg-gradient-to-br from-blue-600 via-violet-500 to-violet-500 rounded-[80px]" />
                    ...
                    <div className="absolute top-96 left-12 w-[79.20px] h-[90px] bg-gradient-to-br from-blue-600 via-violet-500 to-violet-500 rounded-[80px]" />
                </div>
